...
As of 2026-07-16, Multi-Agent Tasks 1–13 are implemented and Task 14 remains the release gate. Calculation proposes from verified candidate facts without a preselected winner, and deterministic policy replay remains post-proposal validation. The latest final-code live attempt reached complete coverage then failed closed in Calculation without publication; use `docs/acceptance/2026-07-15-multi-agent-live-acceptance.md` as the canonical source for current Task 14 evidence and blockers.
