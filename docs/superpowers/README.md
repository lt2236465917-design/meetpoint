...
4. `specs/2026-07-27-input-integrity-and-terminal-ux-hardening-design.md` — approved Repository Audit Batch C contract.
5. `plans/2026-07-27-input-integrity-and-terminal-ux-hardening.md` — reviewed failing-first Batch C execution sequence.
...
Batch C design `specs/2026-07-27-input-integrity-and-terminal-ux-hardening-design.md` was approved on 2026-07-27. Implementation follows the reviewed plan and is not complete until fresh focused/full gates pass.
