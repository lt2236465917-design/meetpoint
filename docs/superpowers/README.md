...
9. `plans/2026-07-28-background-recommendation-run-worker.md` — Compose `run-worker` plan: Tasks 1–7 complete; ECS leave-and-finish checklist #11 PASS (2026-07-28); the former `202607280001` history gap was reconciled on 2026-08-02.
10. `plans/2026-07-27-aliyun-mainland-production.md` — historical mainland release execution plan; current evidence is the 2026-08-02 production acceptance.
