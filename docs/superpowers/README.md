...
5. `specs/2026-07-18-inner-atmosphere-meetup-copy-design.md` — **approved, not yet shipped:** plan/result/records light scenic continuity; create/join static deepen; host CTA「开始见面」; departure prefecture search merge; create participant dropdown opens upward. Plan: `plans/2026-07-18-inner-atmosphere-meetup-copy.md`.
