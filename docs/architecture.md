...
The local hardening migration is `supabase/migrations/202607210001_publication_safety_and_run_recovery.sql`. This implementation batch does not query or apply remote migration state and does not run live supplier acceptance; both remain explicit operator work.
