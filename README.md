...
Repository Audit Batches A and B are implemented and their hardening migrations `202607210001_publication_safety_and_run_recovery.sql` and `202607260001_atomic_materialization_and_policy_replay.sql` were applied to the linked Supabase project on 2026-07-27. Remote role/publication checks and rollback-safe automatic/alternative RPC smoke passed; the controlled live supplier run safely ended incomplete because real quote coverage was insufficient. Batch C is complete locally: real calendar dates, canonical departure identity, bounded plan-code collision recovery, fallback arrival-instant parity, and actionable private-preview terminal states. See [document authority](docs/superpowers/README.md), [Batch B remote acceptance](docs/acceptance/2026-07-27-repository-audit-batch-b-remote-acceptance.md), and [Batch C local acceptance](docs/acceptance/2026-07-27-repository-audit-batch-c-local-acceptance.md).
