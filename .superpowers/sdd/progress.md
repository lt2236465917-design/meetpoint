...
- Next: begin Task 9 with failing run-orchestrator, calculate-run, calculate-route, plan-read, and recommendation-run-schema tests; retain Task 7 policy budgets as explicit deterministic rejections for the orchestrator.
