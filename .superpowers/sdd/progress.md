...
- Mainland go-live (2026-07-28): `www.meetpoint.space` via Nginx → `127.0.0.1:3001`; private gateway + `run-worker`; scenic CDN `media.meetpoint.space`. Remote preflight PASS; #11 PASS; phone rows #1–10 and public-security filing remain open.
- Cleanup: keep Batch B worktrees/stashes until mainland phone gate stable. Prior Vercel evidence: `docs/acceptance/2026-07-27-production-release-acceptance.md`.
