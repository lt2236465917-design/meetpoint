...
- Batch C re-audit (2026-07-27): public automatic-progress isolation and core fast-policy instant comparison are already fixed and removed from new work. Verified remaining scope is canonical departure code/name binding, real Gregorian date validation, fallback latest-arrival instant aggregation, private-preview terminal UX, and bounded plan-code collision recovery. Proposed design and draft plan exist under `docs/superpowers/`; implementation has not begun.
